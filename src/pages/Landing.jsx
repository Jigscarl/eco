    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <button
            onClick={onGetStarted}
            className="bg-green-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-green-700 transition-colors inline-flex items-center space-x-2"
          >
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Reduce Impact</h3>
            <p className="text-gray-600">
